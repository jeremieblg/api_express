...
"use strict";
eval("\nexports.__esModule = true;\nvar express = __webpack_require__(/*! express */ \"express\");\nvar chalk_1 = __webpack_require__(/*! chalk */ \"chalk\");\nvar emoji = __webpack_require__(/*! node-emoji */ \"node-emoji\");\nvar app = express();\nvar _a = process.env.PORT, PORT = _a === void 0 ? 3000 : _a;\napp.get(\"/\", function (req, res) {\n    res.send({\n        message: \"hello world\"\n    });\n});\napp.listen(PORT, function () {\n    console.log(emoji.get(\"heavy_check_mark\") +\n        chalk_1[\"default\"].white.bgGreen.bold(\"API START\") +\n        \" \" +\n        chalk_1[\"default\"].blue.underline(\"http://localhost:\" + PORT));\n});\n// var URL = \"http://localhost:\" + process.env.PORT;\n// app.listen(process.env.PORT, () => {\n//\n// });\n\n\n//# sourceURL=webpack:///./src/index.ts?");
